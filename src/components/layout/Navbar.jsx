...
export default function Navbar({ activePage, setActivePage, theme, toggleTheme, isAuthenticated, onLogout }) {
      ...
      <ul className="navbar__links">
        ...
        {isAuthenticated ? (
          <li className="navbar__user-menu">
            ...
            {showUserMenu && (
              <div className="user-menu-dropdown neo-out">
                <button
